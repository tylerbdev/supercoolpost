		...
		<div class="colleft">
			<div class="col1">
				<div class="main_box">
					...
					<textarea class="textbox" cols="40" rows="1" name="title"><?php echo $row[0]['title']?></textarea>
					<label>Blog Subtitle:</label></br>
					<textarea class="textbox" cols="40" rows="1" name="subtitle"><?php echo $row[0]['subtitle']?></textarea>
